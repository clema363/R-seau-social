    ...
    <div id="nav_plus">
        <nav>
            ...
            <ul>
                ...
                <li><a href="notifications.php" class="active"><img class="icone" src="images/icones/notifications_noir.png" data-hover="images/icones/notifications_noir.png">  Notifications</a></li>
