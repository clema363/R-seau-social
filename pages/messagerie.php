    ...
    <div id="nav_plus">
        <nav>
            ...
            <ul>
                ...
                <li><a href="messagerie.php" class="active"><img class="icone" src="images/icones/messagerie_bleu.png" data-hover="images/icones/messagerie_noir.png">  Messagerie</a></li>
